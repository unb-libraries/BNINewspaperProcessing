...
if __name__ == "__main__":
    ...
    if options.action_stop:
        ...
        daemon.restart(options.config_file)
    elif options.action_start:
        print "Starting " + sys.argv[0]
        daemon.start(options.config_file)
    sys.exit(0)
